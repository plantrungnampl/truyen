                                                        ...
                                                        <Card>
                                                            <CardContent className="p-0">
                                                                <div className="relative">
                                                                    ...
                                                                    />
                                                                    <div
                                                                        className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 bg-gradient-to-t from-black to-transparent">
                                                            ...
                                                            <CardContent className="p-0">
                                                                <div className="relative">
                                                                    ...
                                                                    <div className="absolute top-2 right-2">
                                                                        <Heart
                                                                            className="h-5 w-5 sm:h-6 sm:w-6 text-red-500 fill-current"/>
                                                                    </div>
                                                                    <div
                                                                        className="absolute bottom-0 left-0 right-0 p-3 sm:p-4 bg-gradient-to-t from-black to-transparent">
                                                                        <h4 className="font-bold text-white text-sm sm:text-base">
